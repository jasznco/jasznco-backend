...
module.exports = {
    ...
    deleteCategory: async (req, res) => {
        try {
            ...
            return response.ok(res, null, { message: 'Category deleted successfully' });
        } catch (error) {
            return response.error(res, error);
        }
    },
    ...
    addSubcategory: async (req, res) => {
        try {
            ...
            return res.status(201).json({ message: 'Subcategory added successfully', subcategories: category.Subcategory });
        } catch (error) {
            return response.error(res, error);
        }
    },
    ...
    deleteSubcategory: async (req, res) => {
        try {
            ...
            const subcategoryIndex = category.Subcategory.findIndex(sub => sub._id.toString() === subId);
